...
CALL sp_InitializeMonthlyScores(8, 2024);

CALL sp_InitializeMonthlyScores(9, 2024);

CALL sp_InitializeMonthlyScores(10, 2024);

CALL sp_InitializeMonthlyScores(11, 2024);

CALL sp_InitializeMonthlyScores(12, 2024);

CALL sp_InitializeMonthlyScores(1, 2025);

CALL sp_InitializeMonthlyScores(2, 2025);

CALL sp_InitializeMonthlyScores(3, 2025);

CALL sp_InitializeMonthlyScores(4, 2025);

CALL sp_InitializeMonthlyScores(5, 2025);

CALL sp_InitializeMonthlyScores(6, 2025);
...
CALL sp_InitializeMonthlyScores(8, 2026);
